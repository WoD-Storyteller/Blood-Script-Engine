...
const dashboard_module_1 = require("../companion/dashboard.module");
...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        imports: [database_module_1.DatabaseModule, companion_module_1.CompanionModule, dashboard_module_1.DashboardModule],
